<div class="br_settings_footer">
	...
	if ( isset( $this->plugin_version_capability ) && $this->plugin_version_capability == 3 ) {
		$text = '<h4><a href="%plugin_link%" target="_blank">%plugin_name%</a> developed by <a href="https://berocket.com' . $meta_data . '" target="_blank">Ramphor</a></h4>';
	} elseif ( isset( $this->plugin_version_capability ) && $this->plugin_version_capability <= 5 ) {
		$text = '<h4>Both <a href="%plugin_link%" target="_blank">Free</a> and <a href="%link%" target="_blank">Paid</a> versions of %plugin_name% developed by <a href="https://berocket.com' . $meta_data . '" target="_blank">Ramphor</a></h4>';
	} else {
		$text = '<h4><a href="%plugin_link%" target="_blank">%plugin_name%</a> developed by <a href="https://berocket.com" target="_blank">Ramphor</a></h4>';
	}
